...
const cosmic: ArcadeTheme = {
  ...
  // Game-element energy is the concept art's gold ramp on cosmic space
  // (Praveen's generated key art settled the cosmic-vs-ember ring question
  // as a hybrid). Brand accents (CTA gradient) stay site blue-violet.
  ring: {
    core: "#f6d558",
    mid: "#f0a33f",
  ...
  particles: ["#f6d558", "#f0a33f", "#ffe9b0"],
  flash: "#eef0ff",
  ...
  dom: {
    ...
    "--ah-hud-blur": "14px",
    "--ah-accent": "#f0a33f",
    "--ah-accent-soft": "rgba(240,163,63,0.35)",
    "--ah-chip-bg": "rgba(20,28,46,0.82)",
    "--ah-chip-border": "rgba(240,163,63,0.45)",
    "--ah-chip-text": "#EAF2FF",
