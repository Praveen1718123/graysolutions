...
export const pageImports = {
  ...
  krft: () => import("@/pages/krft"),
  thottam: () => import("@/pages/thottam"),
  kopo: () => import("@/pages/kopo"),
  cafe66: () => import("@/pages/cafe66"),
  "photo-automation": () => import("@/pages/photo-automation"),
  // Service sub-pages
...
export function preloadByPath(path: string) {
  const mapping: Record<string, keyof typeof pageImports> = {
    ...
    "/case-study/krft": "krft",
    "/case-study/thottam": "thottam",
    "/case-study/kopo": "kopo",
    "/case-study/cafe66": "cafe66",
    "/case-study/photo-automation": "photo-automation",
