...
export default function ServiceAutomationsAI() {
  ...
  const whoIsFor = [
    { icon: "🏢", title: "Agencies", desc: "Losing leads due to slow follow-up" },
    { icon: "⏰", title: "Teams", desc: "Wasting hours on manual admin + reporting" },
    { icon: "👤", title: "Founders", desc: "Who want a proper CRM + pipeline discipline" },
    { icon: "📱", title: "Businesses", desc: "Needing WhatsApp-first automation (India-friendly)" },
  ];

  const problems = [
    "Leads come in but nobody responds fast",
    "No pipeline visibility (leads scattered in WhatsApp/Sheets)",
    "Manual follow-ups → inconsistent conversions",
    "No automations for reminders, assignments, updates",
    "Reporting is painful and delayed",
    "Support/replies repeat the same questions daily",
  ];
  ...
  const modules = [
    ...
    },
    {
      ...
      items: [
        ...
        "Auto-replies + qualification",
        "CRM setup + lead scoring",
        "Pipeline stages + SOPs",
      ],
    },
    {
      title: "AI & Dashboards",
  ...
  const packages = [
    {
      ...
      badge: "Set A",
      description: "Fastest ROI: speed to lead.",
      timeline: "1–2 weeks",
      features: [
        "Lead capture setup",
        "Auto-routing + notifications",
        "WhatsApp auto-replies",
        "Basic CRM integration",
      ],
    },
    {
      name: "CRM + Pipeline Build",
      badge: "Set B",
      description: "Structure + reporting for your sales process.",
      timeline: "3–4 weeks",
      features: [
        "Full CRM setup",
        "Pipeline stages",
    ...
    },
    {
      ...
      badge: "Set C",
      description: "Monthly: improve + expand workflows.",
  ...
  const process = [
    { step: "01", title: "Audit", description: "We map your current workflows and identify gaps." },
    { step: "02", title: "Map Workflows", description: "We design the automation logic and integrations." },
    { step: "03", title: "Build", description: "We set up automations and test thoroughly." },
    { step: "04", title: "Launch & Optimize", description: "We go live and continuously improve." },
  ];
  ...
  const faqs = [
    { q: "What tools do you use?", a: "Depends on your stack: Zapier/Make, WhatsApp providers, HubSpot/Zoho, Google Sheets, etc." },
    { q: "Do you build custom too?", a: "Yes if needed, but we start lean and iterate." },
    { q: "Can you do AI without making it cringe?", a: "Yes — AI is for speed + consistency, not fake \"human\" vibes." },
  ];
    ...
    <div className="min-h-screen w-full font-sans overflow-x-hidden" style={{ backgroundColor: '#FAFAFA', color: '#1A1A1A' }}>
      ...
      <section className="relative w-full" style={{ height: '100vh', minHeight: '600px' }}>
        <video
          ...
          src="/assets/automations-ai-video.mp4"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              Stop losing leads. Stop doing repetitive work.
            </h1>
            <p className="text-lg md:text-xl leading-relaxed" style={{ color: 'rgba(255,255,255,0.85)' }}>
              We set up automations + AI workflows across lead capture, CRM, WhatsApp/email follow-ups, reporting, and internal ops.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <p className="text-lg leading-relaxed" style={{ color: '#666666' }}>
                An automation studio that connects your lead capture, CRM, follow-ups, and reporting into one seamless system. We help you respond faster and work less manually.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div>
              <p className="text-lg leading-relaxed" style={{ color: '#666666' }}>
                Most businesses lose leads and waste time because systems aren't connected. Here's what we fix:
              </p>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#1A1A1A' }}>
        <div className="max-w-[800px] mx-auto px-6 md:px-10 text-center">
          ...
          <p className="text-lg mb-8" style={{ color: 'rgba(255,255,255,0.7)' }}>
            Get a Workflow Audit and we'll show the quickest fixes.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="flex justify-between items-center">
            <div className="w-1/2 pr-4">
              <Link href="/services/commerce-studio" className="group flex items-center gap-3">
            ...
            <div className="w-1/2 pl-4 text-right">
              <Link href="/services/brand-content" className="group inline-flex items-center gap-3 justify-end">
                <div>
