...
export default function ServiceProductWeb() {
  ...
  const whoIsFor = [
    { icon: "🚀", title: "Founders", desc: "Launching an MVP fast but clean" },
    { icon: "📊", title: "Businesses", desc: "With a site that looks fine but converts badly" },
    { icon: "🔧", title: "Teams", desc: "Needing UX cleanup before building more features" },
    { icon: "🏢", title: "Companies", desc: "Migrating from \"patchwork screens\" to a real product system" },
  ];

  const problems = [
    "Users don't understand the flow → drop-offs happen",
    "Too many screens, no structure, no hierarchy",
    "Website is \"pretty\" but not conversion-driven",
    "Dev builds without UX logic → rework + delays",
    "No design system → inconsistent UI + slow iteration",
  ];
  ...
  const packages = [
    {
      name: "Website Conversion Revamp",
      badge: "Set A",
      description: "Best for service businesses needing better conversion.",
      timeline: "2–4 weeks",
      features: [
        "Conversion audit",
        "Landing structure",
    ...
    },
    {
      name: "MVP Build",
      badge: "Set B",
      description: "0 → v1 in weeks, not months.",
      timeline: "4–8 weeks",
      features: [
        "Product strategy",
        "UX architecture",
  ...
  const process = [
    { step: "01", title: "Audit", description: "We review your current product/website and identify gaps." },
    { step: "02", title: "UX Flow", description: "We design the user journey and information architecture." },
    { step: "03", title: "UI System", description: "We create clean, consistent UI with a design system." },
    { step: "04", title: "Build & Launch", description: "We develop, test, and launch with QA support." },
  ];
  ...
  const outcomes = [
    ...
    "Cleaner product direction",
    "Scalable design system",
  ];

  const faqs = [
    { q: "Do you do design only?", a: "Yes, we can deliver handoff-ready designs if you have your own dev team." },
    { q: "Do you also build?", a: "Yes, design + dev together is our preferred approach for best results." },
    { q: "Which tech stack do you use?", a: "Depends on project requirements; we always ship clean and maintainable code." },
  ];
    ...
    <div className="min-h-screen w-full font-sans overflow-x-hidden" style={{ backgroundColor: '#FAFAFA', color: '#1A1A1A' }}>
      ...
      <section className="relative w-full" style={{ height: '100vh', minHeight: '600px' }}>
        <video
          ...
          src="/assets/product-web-video.mp4"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              Design and build digital products people don't struggle to use.
            </h1>
            <p className="text-lg md:text-xl leading-relaxed" style={{ color: 'rgba(255,255,255,0.85)' }}>
              We handle UX, UI, and development for websites and MVPs — with conversion, usability, and scalability baked in.
            </p>
          </motion.div>
        </div>
            ...
            <div>
              ...
              <Link href="/contact">
                <button className="mt-6 px-6 py-3 rounded-full font-medium text-sm transition-all hover:opacity-90" style={{ backgroundColor: '#1A1A1A', color: '#FFFFFF' }}>
                  Get a UX + Website Audit
                </button>
              </Link>
            </div>
            <div>
              <p className="text-lg leading-relaxed" style={{ color: '#666666' }}>
                A product design and development studio that builds websites and MVPs with UX logic, clean UI, and conversion focus. We ship products that work, not just look good.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20" style={{ backgroundColor: '#FAFAFA' }}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="text-center mb-10">
            ...
            <h2 className="font-bold" style={{ fontSize: 'clamp(28px, 4vw, 42px)', lineHeight: '1.15', color: '#1A1A1A', letterSpacing: '-0.02em' }}>
              Built For Product-Minded Teams
            </h2>
          </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div>
              <p className="text-lg leading-relaxed" style={{ color: '#666666' }}>
                Most products fail because design and development are disconnected. Here's what we fix:
              </p>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#1A1A1A' }}>
        <div className="max-w-[800px] mx-auto px-6 md:px-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#FFFFFF' }}>
            Want a product/website teardown?
          </h2>
          <p className="text-lg mb-8" style={{ color: 'rgba(255,255,255,0.7)' }}>
            Get a UX + Website Audit with clear fixes and priorities.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="flex justify-between items-center">
            <div className="w-1/2 pr-4">
              <Link href="/services/growth-performance" className="group flex items-center gap-3">
