          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <input
                ...
                className="px-4 py-2.5 text-sm w-full sm:w-64"
                style={{ 
              ...
              />
              <button 
                className="px-5 py-2.5 font-medium text-sm flex items-center justify-center gap-2 transition-all hover:opacity-90 whitespace-nowrap"
                style={{ 
              ...
              <div className="flex items-end gap-4 md:gap-6 flex-wrap">
                <Link href="/">
                  <img 
                    ...
                    style={{ height: 'clamp(50px, 10vw, 100px)', width: 'auto' }}
